  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Byt bild">Byt</button>' +
        '  <button data-act="edit" title="Justera bildutsnitt">Justera</button></div>' +
    ...
    _render() {
      ...
      this._cap.textContent = this.getAttribute('placeholder') || 'Släpp en bild här';
